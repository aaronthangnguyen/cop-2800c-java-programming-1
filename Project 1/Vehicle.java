...
public class Vehicle {
    ...
    // instance methods
    public void wash() {
        System.out.println("Vehicle is clean!");
    }

    // static fields
    public static int vinNumberLength = 17;

    // static methods
    public static boolean checkVinNumberLength(String vinNumber) {
        return vinNumber.length() == Vehicle.vinNumberLength;
    }
}
